...
namespace WebServiceDemo1 {
	...
	public partial class SharePointLinqDataContext : Microsoft.SharePoint.Linq.DataContext {
		
		#region Extensibility Method Definitions
		partial void OnCreated();
		#endregion
		
		public SharePointLinqDataContext(string requestUrl) : 
				base(requestUrl) {
			this.OnCreated();
		}
		...
		[Microsoft.SharePoint.Linq.ListAttribute(Name="test List")]
		public Microsoft.SharePoint.Linq.EntityList<Item> TestList {
			get {
				return this.GetList<Item>("test List");
			}
		}
	}
